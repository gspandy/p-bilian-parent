...
/**
 * A {@link ClassPathBeanDefinitionScanner} that registers Mappers by {@code basePackage}, {@code
 * annotationClass}, or {@code markerInterface}. If an {@code annotationClass} and/or {@code
 * markerInterface} is specified, only the specified types will be searched (searching for all
 * interfaces will be disabled).
 * <p>
 * This functionality was previously a private class of {@link MapperScannerConfigurer}, but was
 * broken out in version 1.2.0.
 *
...
public class ClassPathMapperScanner extends ClassPathBeanDefinitionScanner {
     ...
     * interfaces or just for those that extends a markerInterface or/and those annotated with the
     * annotationClass
     */
     ...
     * objects are post processed to set them as MapperFactoryBeans
     */
    @Override
