 ...
 * <p>
 * This class was a {code BeanFactoryPostProcessor} until 1.0.1 version. It changed to {@code
 ...
 * In this case you must explicitly specify either an {@code SqlSessionFactory} or an {@code
 * SqlSessionTemplate} to use via the <em>bean name</em> properties. Bean names are used rather than
 * actual objects because Spring does not initialize property placeholders until after this class is
 * processed.
 * <p>
 ...
 * placeholder substituation is completed. However, note that this configurer does support property
 * placeholders of its <em>own</em> properties. The <code>basePackage</code> and bean name
 * properties all support <code>${property}</code> style substitution.
 * <p>
 * Configuration sample:
 * <p>
 * <p>
 * <pre class="code"> {@code <bean class="com.chinaredstar.perseus.db.MapperScannerConfigurer">
 * <property name="basePackage" value="org.mybatis.spring.sample.mapper" /> <!-- optional unless
 * there are multiple session factories defined --> <property name="sqlSessionFactoryBeanName"
 * value="sqlSessionFactory" /> </bean> } </pre>
 *
